...
For this test in particular, we do a little wizardry based on
https://gist.github.com/singingwolfboy/2fca1de64950d5dfed72?permalink_comment_id=4556252#gistcomment-4556252
to test the registration and login forms without setting WTF_CSRF_ENABLED=False
in TestConfig. Essentially, any GET request will generate a valid CSRF token,
