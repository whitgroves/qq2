...
def register() -> flask.Response:
    ...
    match flask.request.method:
        ...
        case _:
            flask.current_app.logger.warn(f'@ /register: {flask.request.method} : {flask.request}')
            flask.abort(405)
...
def login() -> flask.Response:
    ...
    match flask.request.method:
        ...
        case 'POST':
            ...
            user:models.User = \
                models.User.query.filter(
                    ext.db.or_(models.User.email==user_email,
        ...
        case _:
            flask.current_app.logger.warn(f'@ /login: {flask.request.method} : {flask.request}')
            flask.abort(405)
